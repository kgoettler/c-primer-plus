 ...
 * calculates how much money you get in 20 days if you receive $1 the first day,
 * $2 the second day, $3 the third day, and so on.) Modify the program so that
 * you can tell it interactively how far the calculation should proceed. That
